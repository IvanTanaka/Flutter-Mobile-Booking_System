...
class SharedColors {
//  NEW COLOR
  static const LinearGradient gradientOrangeColor = LinearGradient(colors: [
    Color(0xFFEB8C57),
    Color(0xCEEB8C57),
    Color(0x33EB8C57),
  ]);
...
//  OLD COLOR
  ...
  static const Color txtAccentColor = Color(0xFFFFFFFF);
  static const Color linkColor = Color(0xFF2F25F5);
  ...
  static const Color badgeColor = Color(0xFFFAB122);
  static const Color primaryBlue = Color(0xFF293FFF);
}